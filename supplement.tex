...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.48\textwidth]{figures/depth_umgs_field_rgb.png}\hfill
    \includegraphics[width=0.48\textwidth]{figures/depth_vineyard01_rgb.png}\\[0.4em]
    \includegraphics[width=0.48\textwidth]{figures/depth_vineyard03_rgb.png}\hfill
    \includegraphics[width=0.48\textwidth]{figures/depth_aerial_golf_rgb.png}
