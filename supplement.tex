...
Aligned depth diagnostics use sparse point-splat references from available transforms and point support. They are secondary reference-depth evidence, not dense MVS or LiDAR ground truth. The geometry claims therefore use relative-depth consistency and do not claim absolute dense geometry accuracy.
