...
\begin{itemize}
    \item A geometry-locked multispectral Gaussian formulation that uses RGB as the geometric carrier for product-ready spectral-index synthesis.
