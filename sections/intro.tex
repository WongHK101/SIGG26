...
\begin{itemize}
    ...
    \item A UAV-focused benchmark with image, index, depth-reference, cost, and external common-mask comparisons under unified reporting.
\end{itemize}
