...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/umgs_method_overview_placeholder.png}
...
\begin{itemize}
    ...
    \item A shared-support/product audit showing why Scratch-MS and Unfrozen-support can be useful single-band diagnostics but invalid product models.
    \item Unified image, index, cost, common-mask, and validation-gated reference-depth reporting on a UAV-focused evaluation suite assembled from project-owned and external sources, with raw-scene rectification QA as supporting infrastructure.
\end{itemize}
