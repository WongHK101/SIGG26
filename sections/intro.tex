...
\begin{itemize}
    ...
    \item Unified image, index, cost, and common-mask reporting on a UAV-focused evaluation suite, with reference-depth diagnostics reported only when the reference source passes validation.
